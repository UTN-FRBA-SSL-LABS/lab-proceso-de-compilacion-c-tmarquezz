...
> **R:La diferencia masiva entre lineas se debe a varios factores, como se menciona justamente, el #include copia el contenido de los headers del sistema por completo, ademas podemos sumar que el #define tambien suma ya que el preprocesador reeemplaza textualmente el codigo fuente, haciendo que el texto sea mas extenso.**
...
> **R:Ocurre ya que el preprocesador elimina todos los comentarios y los reemplaza por un espacio en blanco, por lo que cualquier rastro de ellos desaparece, en este caso la frase de Archivo fuente principal de programa.i**
